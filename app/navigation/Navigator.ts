...
function MainNavigator (){Platform.select({
...
const RootSwitch = createBottomTabNavigator({ HomeStack, SettingsStack });//createSwitchNavigator({ LoadingScreen, MainNavigator });
